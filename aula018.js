...
/** Aqui será verificado a diferença entre o Loop While e o Do While.
 * Ambos são usados em situações  indefinidas, ou seja, quando não se
 * sabe a quantidade de vezes que serão iteradas o bloco de comandos.
 ...
 * o bloco nem chega a ser executado nenhuma vez.
 ...
 * verificada no final da extrutura e  mesmo se der falso na primeira
 * na primeira verificação, o primeiro laço já foi executado.
 * 
